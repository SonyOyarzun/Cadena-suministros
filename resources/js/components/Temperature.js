    ...
    componentDidMount() {
        ...
        axios.all([
            ...
            .then(responseArr => {
                ...
                console.log('Temperature mount2:',responseArr[1][responseArr[1].length - 1].temp)
                    this.setState({
                        chain:  responseArr[1][responseArr[1].length - 1].temp[0],
                        value:  responseArr[1][responseArr[1].length - 1].temp[1],
                        min:    responseArr[1][responseArr[1].length - 1].temp[2],
                        max:    responseArr[1][responseArr[1].length - 1].temp[3],
